...
public class Lector extends Persona{
    ...
    public Lector(int idLector, int estadoLector, int tipoLector, int identificacion, String nombreCompleto, int edad, String fechaNacimiento, String lugarNacimiento, String direccion, String nacionalidad) {
